...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/3.32/gnome-bluetooth-3.32.0.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-3.32.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552326177
