...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/3.34/gnome-bluetooth-3.34.1.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-3.34.1
cd %{_builddir}/gnome-bluetooth-3.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584551663
