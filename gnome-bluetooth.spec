...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/3.34/gnome-bluetooth-3.34.0.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-3.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568043543
