...
Version  : 3.28.1
Release  : 12
URL      : https://download.gnome.org/sources/gnome-bluetooth/3.28/gnome-bluetooth-3.28.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-bluetooth/3.28/gnome-bluetooth-3.28.1.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-3.28.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1532028832
