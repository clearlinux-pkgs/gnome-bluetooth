...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/42/gnome-bluetooth-42.2.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-42.2
cd %{_builddir}/gnome-bluetooth-42.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657208688
...
cp %{_builddir}/gnome-bluetooth-42.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-bluetooth/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/gnome-bluetooth-42.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-bluetooth/545f380fb332eb41236596500913ff8d582e3ead
...
/usr/lib64/libgnome-bluetooth-3.0.so.13.1.0
/usr/lib64/libgnome-bluetooth-ui-3.0.so.13
/usr/lib64/libgnome-bluetooth-ui-3.0.so.13.1.0
