...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/3.28/gnome-bluetooth-3.28.0.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-3.28.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1526052702
