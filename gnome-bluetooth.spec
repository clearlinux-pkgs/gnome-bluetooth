...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/3.34/gnome-bluetooth-3.34.3.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-3.34.3
cd %{_builddir}/gnome-bluetooth-3.34.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601595679
...
cp %{_builddir}/gnome-bluetooth-3.34.3/COPYING %{buildroot}/usr/share/package-licenses/gnome-bluetooth/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/gnome-bluetooth-3.34.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-bluetooth/545f380fb332eb41236596500913ff8d582e3ead
