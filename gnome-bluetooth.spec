...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/47/gnome-bluetooth-47.0.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-47.0
cd %{_builddir}/gnome-bluetooth-47.0
pushd ..
cp -a gnome-bluetooth-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726760803
