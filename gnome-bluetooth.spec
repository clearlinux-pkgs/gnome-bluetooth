...
Source0  : https://download.gnome.org/sources/gnome-bluetooth/42/gnome-bluetooth-42.8.tar.xz
...
%prep
%setup -q -n gnome-bluetooth-42.8
cd %{_builddir}/gnome-bluetooth-42.8
pushd ..
cp -a gnome-bluetooth-42.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707240676
